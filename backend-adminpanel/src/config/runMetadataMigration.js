...
const runMigration = async () => {
    try {
        console.log('⏳ Running Image Metadata Columns Migration...');

        const migrationPath = path.join(__dirname, 'add_image_metadata_columns.sql');
        ...
        console.log('✅ Image Metadata Migration Completed!');
        process.exit(0);
    } catch (error) {
